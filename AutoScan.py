...
def print_header():
 ...
 ____   ____        ____         _____          _____         _____            ______        _____          ____  _____   ______   
...
|    | |    ||    .--.    ||    |   |    ||    |   |    ||    |\    \ |    \    \___|/ |    |   ____ |    .--.    | |      \ |    |
|    | |    ||    |  |    ||    |   |_,  ||    |   |_,  ||    | |    ||    |\     \    |    |  |    ||    |  |    | |    |\ \|    |
|____| |____||____|  |____||\ ___\___/  /||\ ___\___/  /||____| |____||\ ___\|_____|   |\ ___\/    /||____|  |____| |____||\_____/|
|    | |    ||    |  |    || |   /____ / || |   /____ / ||    | |    || |    |     |   | |   /____/ ||    |  |    | |    |/ \|   ||
|____| |____||____|  |____| \|___|    | /  \|___|    | / |____| |____| \|____|_____|    \|___|    | /|____|  |____| |____|   |___|/
  \(     )/    \(      )/     \( |____|/     \( |____|/    \(     )/      \(    )/        \( |____|/   \(      )/     \(       )/  
   '     '      '      '       '   )/         '   )/        '     '        '    '          '   )/       '      '       '       '   
